            ...
            <div class="top-banner-inner"
                ...
                <div class="top-banner-copy" style="align-items: center; box-sizing: border-box; display: flex; gap: 16px;">
                    ...
                    <div class="top-banner-text"
                        ...
                        <span class="mobile-copy">${(typeof CMS_CONFIG !== 'undefined' && CMS_CONFIG.banner) ? CMS_CONFIG.banner.mobileText : 'Edice VÍTEJ · objednávky do 10. 6. 23:59 · odesílám 15. 6.'}</span>
                    </div>
                </div>
